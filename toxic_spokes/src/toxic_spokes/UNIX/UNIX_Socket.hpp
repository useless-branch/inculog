...
namespace detail {
    ...
    public:
        ...
        UNIX_ServerSocket_Impl&
          operator=(UNIX_ServerSocket_Impl const& other)
          = default;
        UNIX_ServerSocket_Impl(UNIX_ServerSocket_Impl&& other) noexcept = default;
        UNIX_ServerSocket_Impl&
          operator=(UNIX_ServerSocket_Impl&& other) noexcept = default;
        ...
        ClientSocket_t
          accept() {
            return ClientSocket_t{Socket_Impl::accept()};
        }
    };
...
constexpr bool
  isUnixSocket() {
    if constexpr(
      std::is_same_v<
        T,
        UNIX_Packet_ClientSocket> || std::is_same_v<T, UNIX_Packet_ServerSocket> || std::is_same_v<T, UNIX_Stream_ClientSocket> || std::is_same_v<T, UNIX_Stream_ServerSocket>)
    {
        return true;
    }
    return false;
